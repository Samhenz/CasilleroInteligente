package com.css.casillerointeligentecss.fragment;
...
import com.css.casillerointeligentecss.util.ListViewHolder;
    ...
    public void updateAutoEndButton() {
        if (getView() != null) {
            if (LogManager.instance().isAutoEnd()) {
                mBtnAutoEnd.setText("dont show last records");
                mLvLogs.setSelection(mAdapter.getCount() - 1);
            } else {
                mBtnAutoEnd.setText("show last records");
            }
        }
    }
